...
| Milestone | Target Date | Owner | Status |
|-----------|-------------|-------|--------|
| Complete Year 1 actions | {date} | All leads | ☐ |
| Year-end evaluation | {date} | {owner} | ☐ |
| Year 2 planning | {date} | {owner} | ☐ |
| Board presentation | {date} | Supt | ☐ |
...
2. Progress on success indicators (baseline → current → target)?
